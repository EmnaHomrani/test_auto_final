describe('FrontDeskdisconnectionmanagement Workflow', () => {
    ...
    it('Passe à FrontDeskdisconnectionmanagement', () => {
      ...
      cy.contains('span', 'Front Desk disconnection management', { timeout: 10000 })
        .should('be.visible')
        .click();
    
      cy.wait(500);
    
      cy.xpath('/html/body/app-root/app-order-details/div/div[6]/app-offers-section/ngb-accordion/div/div[2]/div/div/app-activity-section/div[3]/div/form/div[1]/div[1]/div/app-disco-fd-activity/div/form/div/div/div/div/div/mat-checkbox/label/span[1]', { timeout: 15000 })
  .should('be.visible')
  .click({ force: true })
  cy.wait(500);
