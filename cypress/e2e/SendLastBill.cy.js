describe('FrontDeskdisconnectionmanagement Workflow', () => {
    ...
    it('Passe à SendLastBill', () => {
        cy.xpath(
          '/html/body/app-root/app-order-details/div/div[5]/app-order-qualification/div/div[2]/div/div[2]/app-activity-section/div[2]/table/tbody/tr[6]/td[2]/span',
          { timeout: 10000 }
        )
          .should('contain.text', 'Send Last Bill')
          .should('be.visible')
          .click();
