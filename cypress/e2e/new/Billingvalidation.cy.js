describe('Billing validation Workflow', () => {
    before(() => {
      cy.loginAndSearch();
    });
  
    it('Passe à Billing validation', () => {
      cy.xpath(
        '/html/body/app-root/app-order-details/div/div[5]/app-order-qualification/div/div[2]/div/div[2]/app-activity-section/div[2]/table/tbody/tr[11]/td[2]/span',
        { timeout: 10000 }
      )
        .should('contain.text', 'Billing validation')
        .should('be.visible')
        .click();
    ...
    cy.xpath(
      '/html/body/app-root/app-order-details/div/div[5]/app-order-qualification/div/div[2]/div/div[2]/app-activity-section/div[3]/div/form/div[1]/div[1]/div/app-billing-validation-activity/div/form/div/div/div/div/mat-form-field/div/div[1]/div/mat-select/div/div[1]/span',
      { timeout: 10000 }
    )
      .should('be.visible')
      .click({ force: true });
    ...
    cy.get('[formcontrolname="invoiceValidated"]', { timeout: 15000 })
    .should('be.visible')
