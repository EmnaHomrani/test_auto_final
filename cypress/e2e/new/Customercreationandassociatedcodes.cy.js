describe('Customer creation & associated codes Workflow', () => {
    before(() => {
      cy.loginAndSearch();
    });
  
    it('Passe à Customer creation & associated codes', () => {
      cy.xpath(
        ...
        .should('contain.text', 'Customer creation & associated codes')
        .should('be.visible')
        .click();
