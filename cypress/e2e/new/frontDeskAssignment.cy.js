describe('Front Desk Assignment Workflow', () => {
    ...
    it('Vérifie et complète Front Desk assignment', () => {
      ...
      cy.xpath('/html/body/app-root/app-order-details/div/div[5]/app-order-qualification/div/div[2]/div/div[2]/app-activity-section/div[2]/table/tbody/tr[1]/td[4]/span', { timeout: 20000 })
        .invoke('text')
        .then((status1) => {
